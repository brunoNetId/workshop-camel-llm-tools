...
NOTE: In this workshop an LLM Server has been pre-deployed for you. By default the server is scaled to 0. In this chapter you simply gain a minimal familiarity by starting and inspecting your LLM.

{blank}

=== Proceed to Start the LLM

Copy and paste in your terminal the following command:

[source, subs=]
----
oc scale deployments/llm-server --replicas=1<br>
----
...
----
deployment.apps/llm-server scaled
----
